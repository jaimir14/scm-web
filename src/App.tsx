...
import ContratosPage from "@/pages/mantenimientos/ContratosPage";
            ...
            <PermissionProvider>
              <Routes>
                ...
                <Route element={<ProtectedRoute><AppLayout /></ProtectedRoute>}>
                  ...
                  <Route path="/mantenimientos/contratos" element={<ContratosPage />} />
                  <Route path="/mantenimientos/contratos/:id" element={<ContratosPage />} />
                  ...
                  <Route path="/admin/roles" element={
                    <ProtectedRoute adminOnly><RolesPermisos /></ProtectedRoute>
                  } />
                </Route>
